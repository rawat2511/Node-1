...
// interface.question(" Press 1, 2 or 3 : ", (input) => {
//     if( Number(input) === 3){
//         interface.close();
//     }
...
var books = ["Alice in the Wonderland", "Kabuliwala", "Guliver's Travels", "Arrabian Nights"];
...
interface.on("line", input => {
    if(Number.parseInt(input) === 1){
        ...
        interface.question("Are you sure you want to quit - press Y to quit ? ", input2 => {
